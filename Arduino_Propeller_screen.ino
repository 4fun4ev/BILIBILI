  ...
  int i;
  char textString[] = "I love U";
  char botString[]= "CHINA";
  ...
  void loop()
  { 
    for (int k=0; k<sizeof(botString); k++){
      printLetter(botString[k]);
      }
    delay(2);  
    for (int k=sizeof(textString)-1; k>-1; k--){
      printLetterabove(textString[k]);
      }  
  }
  
void printLetterabove(char ch)
  {
